...
const images = {
  hero: "https://images.unsplash.com/photo-1601581875309-fafbf2d3ed3a?auto=format&fit=crop&w=1800&q=88",
  ...
  return (
    <>
      <div className="utility-bar">
        <div className="tour-container utility-inner">
          <a href="#support">Talk with a local expert</a>
          <span>Design preview · no live booking</span>
        </div>
      </div>
      <header className="site-header">
        <div className="tour-container nav-row">
          <nav className="desktop-nav" aria-label="Primary navigation">
            <a href="#overview">About</a>
            <a href="#related">Tours</a>
            <a href="#map">Destinations</a>
          </nav>
          <a className="brand-link" href="/" aria-label="WonderAlbania home">
            <img src="/weblogo.png" alt="WonderAlbania" />
          </a>
          <div className="nav-tools">
            <button type="button" className="nav-chip language-chip" aria-label="Choose language"><Globe2 size={18} /><span>EN</span></button>
            <button type="button" className="nav-chip" aria-label="Search"><Search size={18} /></button>
            <button type="button" className="nav-chip" aria-label="Open AI travel assistant"><Sparkles size={18} /></button>
            <button type="button" className="nav-chip" aria-label="Open menu"><Menu size={19} /></button>
          </div>
        </div>
      </header>
    </>
