...
const french: Record<string, string> = {
  ...
  "Local knowledge, firsthand": "Le pays, vécu de l’intérieur",
  "With you all the way": "À vos côtés du début à la fin",
  "Personal support, 24/7": "Assistance personnelle, 24 h/24",
